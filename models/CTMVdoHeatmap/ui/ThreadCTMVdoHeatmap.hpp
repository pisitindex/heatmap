#ifndef ThreadCTMVdoHeatmap_HPP
#define ThreadCTMVdoHeatmap_HPP
...
class ThreadCTMVdoHeatmap : public QThread
{
  Q_OBJECT
public:

  QString name = "CTMVdoHeatmap";
